...
interface Tokenizer {
    ...
    companion object {
        fun from(vocabSize: Int, fileInputStream: FileInputStream): Tokenizer {
            return TokenizerImpl(vocabSize, fileInputStream)
        }
    }
}
...
class TokenizerImpl(
    ...
    tokenizerFileStream: FileInputStream,
) : Tokenizer {
    ...
    init {
        tokenizerFileStream.channel.use { channel ->
...
class Llama2(checkpointFileStream: FileInputStream) : Model {
    ...
    init {
        checkpointFileStream.channel.use { fileChannel ->
            val bb: ByteBuffer =
